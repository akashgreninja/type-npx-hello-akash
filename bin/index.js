...
const colors = {
  ...
  console.log(colors.cyan + "- 🔭 I’m currently working on DSA in Python" + colors.reset);
  console.log(colors.cyan + "- 📫 I have a reputation of 461 on Stack Overflow and am in the top 6% of contributors worldwide in 2023." + colors.reset);
  console.log(colors.cyan + "- 📫 I am ranked 526,726 on LeetCode and striving to improve." + colors.reset);
  console.log(colors.cyan + "- 🌱 I’m currently learning concepts of DSA and Web3." + colors.reset);
  console.log(colors.cyan + "- 👯 I’m looking to collaborate on Web3 projects." + colors.reset);
